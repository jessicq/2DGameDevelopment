  ...
  channels() 
{
  ...
  sounds.reserve(7);
  sounds.push_back( Mix_LoadWAV("sound/swinubsound.wav") );
  sounds.push_back( Mix_LoadWAV("sound/mephisto-laugh.wav") );
  sounds.push_back( Mix_LoadWAV("sound/diablo-line.wav") );
  sounds.push_back( Mix_LoadWAV("sound/baal-laugh.wav") );
  sounds.push_back( Mix_LoadWAV("sound/xyost.wav") );
  sounds.push_back( Mix_LoadWAV("sound/DungeonMusic.wav") );
